...
my_account.deposit(100).deposit(200).deposit(300).withdraw(700).yield_interest()
her_account.deposit(1000).deposit(2000).withdraw(100).withdraw(200).withdraw(300).withdraw(400).yield_interest()
